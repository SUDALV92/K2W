...
global.timerEnabled = ini_read_real("Settings","TimerEnabled",true);
...
global.suicideButton[0] = ini_read_real("Controls","Items",ord("Q"));
global.pauseButton[0] = ini_read_real("Controls","Pause",ord("P"));
global.alignLeftButton[0] = ini_read_real("Controls","Align_left",vk_delete);
global.alignRightButton[0] = ini_read_real("Controls","Align_right",vk_f5);
...
if (global.controllerEnabled)
{
    ...
    global.controllerSystemButtonsEnabled = ini_read_real("Settings","ControllerSystemButtons",true);
    ...
    global.suicideButton[1] = ini_read_real("Controller","Items",gp_select);
