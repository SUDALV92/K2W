...
ini_write_real("Settings","TimerEnabled",global.timerEnabled);
...
ini_write_real("Controls","Items",global.suicideButton[0]);
...
if (global.controllerEnabled)
{
    ...
    ini_write_real("Settings","ControllerSystemButtons",global.controllerSystemButtonsEnabled);
    ...
    ini_write_real("Controller","Items",global.suicideButton[1]);
